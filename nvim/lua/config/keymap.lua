...
-- Keymap to close floating windows (such as the hover one, line 10)
...
-- Map Control+Space to exit terminal mode
vim.api.nvim_create_autocmd("TermOpen", {
	pattern = "*",
	callback = function()
		vim.api.nvim_buf_set_keymap(0, "t", "<C-Space>", "<C-\\><C-n>", { noremap = true, silent = true })
	end,
})
